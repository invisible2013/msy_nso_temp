!function (a, b) {
    ...
    !function (a) {
        ...
        l.VERSION = "1.12.4", l.DEFAULTS = {
            ...
            constructor: l, init: function () {
                return true; // Prevents default dropdown change
    ...
    return k.init = function (a) {
        ...
        for (var c, d, f = 0,
                 g = a.length; f < g; f++)c = a[f], d = c.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(d) && (p[d](c), c = c.parentElement), -1 === c.className.indexOf("waves-effect") && (c.className += " waves-effect" + b)
    ...
    var a = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
        ...
        c = "undefined" != typeof Element && "ALLOW_KEYBOARD_INPUT" in Element, d = function () {
            for (var b,
                     ...
                     d = 0, e = c.length, f = {}; d < e; d++)if ((b = c[d]) && b[1] in a) {
